...
?>
        ...
        <ul class="nav menu">
            ...
            <li class="parent"><a data-toggle="collapse" href="#sub-item-3">
                <em class="fa fa-money">&nbsp;</em>Budget <span data-toggle="collapse" href="#sub-item-3" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
                <ul class="children collapse" id="sub-item-3">
                    <li><a class="" href="set-budget.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Set Budget
                    </a></li>
                    <li><a class="" href="budget-actual.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Budget vs Actual
                    </a></li>
                </ul>
            </li>
