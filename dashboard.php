		...
		<div class="row">
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					...
					$tdate = date('Y-m-d');
					$query = mysqli_query($con,"select ROUND(sum(ExpenseCost),2) as todaysexpense from tblexpense where date(ExpenseDate)='$tdate' && (UserId='$userid')");
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					...
					$query1 = mysqli_query($con,"select ROUND(sum(ExpenseCost),2) as yesterdayexpense from tblexpense where (ExpenseDate)='$ydate' && (UserId='$userid')");
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					...
					$crrntdte = date("Y-m-d");
					$query2 = mysqli_query($con,"select ROUND(sum(ExpenseCost),2) as weeklyexpense from tblexpense where ((ExpenseDate) between '$pastdate' and '$crrntdte') && (UserId='$userid')");
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					...
					$query3 = mysqli_query($con,"select ROUND(sum(ExpenseCost),2) as monthlyexpense from tblexpense where ((ExpenseDate) between '$monthdate' and '$crrntdte') && (UserId='$userid')");
		...
		<div class="row">
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					...
					<?php
					$cyear = date("Y");
					$query4 = mysqli_query($con,"select ROUND(sum(ExpenseCost),2) as yearlyexpense from tblexpense where (year(ExpenseDate)='$cyear') && (UserId='$userid')");
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
					<?php
					$query5 = mysqli_query($con,"select ROUND(sum(ExpenseCost),2) as totalexpense from tblexpense where UserId='$userid'");
